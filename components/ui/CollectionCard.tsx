  ...
  return (
    <Link href={`/propiedades/${collection.slug || ''}`} className="block group relative rounded-xl overflow-hidden shadow-soft bg-white cursor-pointer">
      ...
      <div className="aspect-4/3 w-full overflow-hidden relative">
        ...
        {/* Tag */}
        <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider text-nordic z-10">
          {collection.tag}
        </div>
